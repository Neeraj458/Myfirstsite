		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/slim jeans2.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/slim jeans2.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/slim jeans.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/slim jeans1.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/slim jeans3.jpg" width="100%" class="smallimage">
						</div>
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">House & Shiels Men's Stretch Slim jeans</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;759.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						...
						<li style="padding-bottom: 4px;">Zip fly with buttoned closure</li>
						<li style="padding-bottom: 4px;">Classic 5 pocket style</li>
						<li style="padding-bottom: 4px;">Branded metal trims</li>
						<li style="padding-bottom: 4px;">Machine wash warm, wash dark colors separately, do not bleach, tumble</li>
					</ul>
					<br><br><br><br><br>
