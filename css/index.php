...
<head>
	...
	<!--<link href="Images/sn1.png" type="image" rel="icon">-->
</head>
<body>
	<div class="header">
		<div class="container">
	...
	<div class="s-container">
		...
		<!--<div class="row">
			<div class="col-4">
				<img src="Images/rustet3.jpg" height="250px">
				<center><h4>Rustet</h4>
			...
			<div class="col-4">
				<img src="Images/timewear.jpg" height="250px">
			...
			<div class="col-4">
				<img src="Images/timex2.jpg" height="250px">
				<center><h4>Timex</h4>
			...
			<div class="col-4">
				<img src="Images/watch2.jpg" height="250px">
				<center><h4>TimeWear</h4>
	...
	<div class="offer">
		<div class="s-container">
			<div class="row">
				<div class="col-2">
					<img src="Images/band1.jpg" class="band">
				</div>
				<div class="col-2">
					<h1>Mi Smart Band 5 - India's No.1 Fitness Band</h1>
					<p>Mi smart Band 5, 1.1" full touch AMOLED color display with 14 days battery life on a single charge battery.</p>
					
					<a href="miband.php" class="button">Shop now</a>
				</div>
			</div>
		</div>
	</div>
