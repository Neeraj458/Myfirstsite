		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/timex2.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/timex2.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/timex3.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/timex4.jpg" width="100%" class="smallimage">
						</div>						
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">TIMEX Anolog Black Men Watch TW00ZR364E</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;1095.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						<li style="padding-bottom: 4px;">Dial color: Black</li>
						<li style="padding-bottom: 4px;">Case shape: Round</li>
						<li style="padding-bottom: 4px;">Dial Glass material: Mineral</li>
						<li style="padding-bottom: 4px;">Band color: Brown, Band Material: Leather</li>
						<li style="padding-bottom: 4px;">Watch movement type: Quartz, Watch Display type: Analog</li>
						<li style="padding-bottom: 4px;">Water resistance depth: 30 meters, Buckle Clasp</li>
						<li style="padding-bottom: 4px;">2 years warranty</li>
					</ul>
					<br><br><br><br><br>
