		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/united jeans4.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/united jeans4.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/united jeans3.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/united jeans2.jpg" width="100%" class="smallimage">
						</div>
						
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">United Jeans Mens Blue Dori Style Relaxed Fit Cotton Cargo Jogger Jeans Pants</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;599.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						<li style="padding-bottom: 4px;">Care instruction: Machine wash</li>
						<li style="padding-bottom: 4px;">Fit type: Regular Fit</li>
						<li style="padding-bottom: 4px;">Fit type: Slim</li>
						<li style="padding-bottom: 4px;">Fit type: Regular fit, 2 side pockets, 100% cotton</li>
						<li style="padding-bottom: 4px;">Sits at waist/ loose fit / straight leg</li>
						<li style="padding-bottom: 4px;">Disclaimer: Product color may slightly vary due to photographic</li>
					</ul>
					<br><br><br><br><br>
