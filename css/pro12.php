		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/watch2.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/watch2.jpg" width="100%" class="smallimage">
						</div>
						
						<div class="simage-col">
							<img src="Images/watch4.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/watch5.jpg" width="100%" class="smallimage">
						</div>						
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">TIMEWEAR Commando Series Analog Digital Multifunction Sports Watch for Men</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9734;
				...
				<p style="padding-top: 8px;">&#8377;659.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						<li style="padding-bottom: 4px;">Waterr resistant | Note - Please Do Not press any buttons in the water</li>
						<li style="padding-bottom: 4px;">Dimension - Case Diameter - 55mm | Case width - 54mm | Case thickness - 17mm | Band width - 22mm | Max perimeter - 240mm | Min perimeter - 170mm</li>
					</ul>
					<br><br><br><br><br>
