		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/timewear.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/timewear.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/timewear3.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/timewear4.jpg" width="100%" class="smallimage">
						</div>						
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">TIMEWEAR Analog Day Date Functioning Stainless Steel Chain Watch for Men</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;329.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						<li style="padding-bottom: 4px;">Dial color: White | Dial diameter: 38mm | Case thickness: 8mm | Band width: 22mm | Max perimeter: 210mm | Min perimeter: 160mm</li>
						<li style="padding-bottom: 4px;">Stainless steel chain | Stainless steel back | Water resistant</li>
						<li style="padding-bottom: 4px;">Premium Day Date watch | Japanese Quartz movement | Battery: 100% Original | Life: 2-3 Years</li>
						<li style="padding-bottom: 4px;">Analog watch for men | Recommended for age 14 and above</li>
					</ul>
					<br><br><br><br><br>
