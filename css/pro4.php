		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/yha.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/yha.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/yha1.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/yha2.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/yha3.jpg" width="100%" class="smallimage">
						</div>
						
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">YHA Men's Regular Fit Casual Check Shirt</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;630.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						...
						<li style="padding-bottom: 4px;">Neck style: Classic collar</li>
						<li style="padding-bottom: 4px;">Sleeve type: Full sleeve</li>
