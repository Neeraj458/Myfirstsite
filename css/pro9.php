		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/rustet3.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/rustet3.jpg" width="100%" class="smallimage">
						</div>
						
						<div class="simage-col">
							<img src="Images/rustet1.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/rustet2.jpg" width="100%" class="smallimage">
						</div>
						
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">RUSTET Analouge Men's & Boy's Day and Date Watch(Black dial Black metal strap,FSTFBLK) (BLACK)</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;375.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						...
						<li style="padding-bottom: 4px;"> Dial shape: Round</li>
						<li style="padding-bottom: 4px;">Strap material: Stainless steel</li>
						<li style="padding-bottom: 4px;">Model: FSTFBLK</li>
						<li style="padding-bottom: 4px;">Warranty Type: 6 Months against manufacturing defects</li>
