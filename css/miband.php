		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/band1.jpg" width="100%" height="500px" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/band1.jpg" width="100%" class="smallimage">
						</div>
						
						<div class="simage-col">
							<img src="Images/band2.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/band3.jpg" width="100%" class="smallimage">
						</div>	
						<div class="simage-col">
							<img src="Images/band4.jpg" width="100%" class="smallimage">
						</div>				
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">Mi Smart Band 5 – India’s No. 1 Fitness Band, 1.1-inch AMOLED Color Display, Magnetic Charging, 2 Weeks Battery Life, Personal Activity Intelligence (PAI), Women’s Health Trackin</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;2499.00</p>
				<hr>
