		...
		<div class="s-container" style="margin-top: 20px;">
			<div class="row">
				<div class="col-2" style="padding: 20px;">
					<img src="Images/Campus sutra2.jpg" width="100%" style="padding: 0;" id="proimage">	

					<div class="simage">
						<div class="simage-col">
							<img src="Images/campus sutra2.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/campus sutra1.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/campus sutra3.jpg" width="100%" class="smallimage">
						</div>
						<div class="simage-col">
							<img src="Images/campus sutra5.jpg" width="100%" class="smallimage">
						</div>
					</div>				
				</div>
				<div class="col-2" style="padding: 20px;">
					<h2 style="padding-bottom: 20px;">Campus Sutra Solid Men Henley Stylish Casual T-Shirt</h2>
					<div class="rating">
					&#9733;
					&#9733;
					&#9733;
				...
				<p style="padding-top: 8px;">&#8377;395.00</p>
				<hr>
				<h3 style="padding: 40px 0 15px">Product details</h3>
					<ul style="list-style-type: disc; padding-left: 16px;">
						<li style="padding-bottom: 4px;">Care instruction: Gentle machine wash</li>
						<li style="padding-bottom: 4px;">Fit type: Regular fit</li>
						<li style="padding-bottom: 4px;">Fabic: Cotton</li>
						<li style="padding-bottom: 4px;">Style: Henley</li>
						<li style="padding-bottom: 4px;">Neck style: Henley</li>
						<li style="padding-bottom: 4px;">Pattern: Solid</li>
					</ul>
					<br><br><br><br><br>
					<?php
